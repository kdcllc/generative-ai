...
public static class Settings
{
    ...
    public static async Task<string> AskAzureEndpoint(
    ...
    public static async Task<string> AskModel(
        bool _useAzureOpenAI = true, 
        string configFile = DefaultConfigFile)
    {
        var (useAzureOpenAI, model, azureEndpoint, apiKey, orgId) = ReadSettings(_useAzureOpenAI, configFile);
    ...
    public static async Task<string> AskApiKey(
        bool _useAzureOpenAI = true, 
        string configFile = DefaultConfigFile)
    {
        var (useAzureOpenAI, model, azureEndpoint, apiKey, orgId) = ReadSettings(_useAzureOpenAI, configFile);
    ...
    public static async Task<string> AskOrg(
        bool _useAzureOpenAI = true, 
        string configFile = DefaultConfigFile)
    {
        var (useAzureOpenAI, model, azureEndpoint, apiKey, orgId) = ReadSettings(_useAzureOpenAI, configFile);
